    ...
    <>
      ...
      {isPopupOpen && popupContent && (
        <div className="fixed top-1/4 left-1 right-0 flex items-center justify-center z-50">
          <div className="relative bg-white/10 backdrop-blur-2xl border border-white/20 rounded-2xl sm:p-8 p-4 w-[750px] h-[60vh] flex flex-col overflow-hidden pb-[5vh]">
            {/* Close Button */}
            <button
              onClick={closePopup}
      ...
      {/* Footer Base */}
      <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 bg-white/20 p-4 rounded-t-xl flex items-center flex-wrap justify-center xl:justify-between gap-6">
